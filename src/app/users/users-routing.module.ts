...
const routes: Routes = [
   {
      ...
      children: [
        ...
        {path: '**', redirectTo: '404/error404'}//wildcard que nos mande a la lista. El wildcard se activará cuando la ruta esté vacía, es decir, al llamar al módulo heroes de inicio.
      ]
   }
];
